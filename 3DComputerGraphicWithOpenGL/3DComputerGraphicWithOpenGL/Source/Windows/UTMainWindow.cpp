...
void UTMainWindow::UpdateWindowDrawContext()
{
	//if (SelectorWindowData.HasSelectedExampleChanged())
	//{
	//	// TODO : Update the context of InputWindow and DescriptionWindow
	//}
}
...
{
	//if (ImGui::CollapsingHeader(RESOURCE_MANAGER->FindContext(2, 0, 0, 0).c_str()))
	//{
	//	ImGui::Indent();
	//	if (ImGui::CollapsingHeader(RESOURCE_MANAGER->FindContext(2, 5, 0, 0).c_str()))
	//	{
	//		ImGui::Indent();
	//		if (ImGui::CollapsingHeader(RESOURCE_MANAGER->FindContext(2, 5, 3, 0).c_str()))
	//		{
	//			ImGui::Indent();
	//			if (ImGui::MenuItem(RESOURCE_MANAGER->FindContext(2, 5, 3, 2).c_str(), nullptr))
	//			{
	//				//UTG::MainWindow->(2, 5, 3, 2);
	//			}
	//			ImGui::Unindent();
	//		}
	//		ImGui::Unindent();
